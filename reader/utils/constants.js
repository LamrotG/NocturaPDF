...
export const PDF_COLOR_MODES = {
  ...
  smart: { id: "smart", label: "Smart", bg: "#1b1e24", fg: "#e8eaed", mode: "preserve", renderer: "cpu", summary: "Best for everyday reading", detail: "A balanced reading mode that darkens the page while preserving colors. A good choice for most documents." },
