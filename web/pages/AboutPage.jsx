...
export default function AboutPage({ onNavigate }) {
  return (
    <PageShell title="About" onNavigate={onNavigate}>
      ...
      <h2 style={sectionTitleStyle}>About Themes</h2>
      <p style={paragraphStyle}>
      ...
      <h3 style={{ fontSize: 16, fontWeight: 600, color: "var(--text-h)", margin: "24px 0 8px" }}>Original — Exact document appearance</h3>
      <p style={paragraphStyle}>Shows the PDF exactly as it was created, without changing its colors or appearance. Best when you want the original document.</p>

      <h3 style={{ fontSize: 16, fontWeight: 600, color: "var(--text-h)", margin: "24px 0 8px" }}>Native — Natural PDF rendering</h3>
      <p style={paragraphStyle}>A simple reading mode that keeps the document's original colors and appearance while using PDF.js's standard rendering.</p>

      <h3 style={{ fontSize: 16, fontWeight: 600, color: "var(--text-h)", margin: "24px 0 8px" }}>Smart — Best for everyday reading</h3>
      <p style={paragraphStyle}>Automatically chooses a suitable reading approach for different types of PDFs. A good choice for most documents.</p>

      <h3 style={{ fontSize: 16, fontWeight: 600, color: "var(--text-h)", margin: "24px 0 8px" }}>Pure Black — Best for OLED screens</h3>
      <p style={paragraphStyle}>Uses a true-black background to make reading more comfortable in dark environments and reduce light from OLED screens.</p>

      <h3 style={{ fontSize: 16, fontWeight: 600, color: "var(--text-h)", margin: "24px 0 8px" }}>GPU Dark — Dark mode with natural colors</h3>
      <p style={paragraphStyle}>Darkens the page while trying to preserve the original colors of images, illustrations, and other content.</p>

      <h3 style={{ fontSize: 16, fontWeight: 600, color: "var(--text-h)", margin: "24px 0 8px" }}>Scan Dark — Best for scanned documents</h3>
      <p style={paragraphStyle}>Designed for scanned PDFs, such as documents made from photos or screenshots. Darkens the page and improves contrast to make scanned text easier to read.</p>

      <h3 style={{ fontSize: 16, fontWeight: 600, color: "var(--text-h)", margin: "24px 0 8px" }}>Preserve — Best for image-heavy PDFs</h3>
      <p style={paragraphStyle}>A gentle dark mode that keeps photos, illustrations, and other visual content closer to their original appearance.</p>
